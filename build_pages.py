...
SVC_PHOTO_FALLBACK = ("wp/London-Ontario-HVAC-Contractor.png", "Leamington Heating & Cooling HVAC technician in service")
SVC_PHOTO = {
 "furnace-repair": ("wp/London-Ontario-HVAC-Contractor.png", "Furnace repair service"),
 "ac-repair": ("wp/London-Ontario-HVAC-Contractor.png", "Air conditioner repair service"),
 ...
 "thermostat-repair-replacement": ("wp/London-Ontario-HVAC-Contractor.png", "Thermostat replacement"),
 "duct-cleaning": ("wp/London-Ontario-HVAC-Contractor.png", "Duct cleaning service"),
}
  ...
  <div class="container">
    <div class="split">
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/London-Ontario-HVAC-Contractor.png" alt="Leamington Heating & Cooling HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">
